...
import { getPosts, getPostsByHashtagID, publishPost } from "../controllers/posts.controllers.js";
...
postRouter.get("/posts/hashtag/:id", authenticate, validateHashtagID ,getPostsByHashtagID);
